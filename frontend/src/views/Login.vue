...
export default {
  ...
  methods: {
    ...
    async handleLogin() {
      ...
      // Nettoyage du localStorage avant toute tentative
      ...
      try {
        ...
        // Configuration explicite du token pour axios
        api.defaults.headers.common['Authorization'] = `Bearer ${token}`;
        console.log('Token configuré dans axios:', token.substring(0, 10) + '...');
        ...
        try {
          await api.post(`/users/${user._id}/points`, { amount: 0.25 });
        ...
        // Redirection après un court délai pour que le token soit bien configuré
        setTimeout(() => {
